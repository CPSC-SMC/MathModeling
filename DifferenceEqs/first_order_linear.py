...
def first_order_linear_delta(xn, a, b):
...
def plot_fol_delta(n,x0,a,b):
    ...
    for i in range(n):
        terms[i+1] = first_order_linear_delta(terms[i],a,b)
...
print plot_fol_delta(20,0.999,2,-1)
print plot_fol_delta(20,1,2,-1)
print plot_fol_delta(20,1.001,2,-1)
